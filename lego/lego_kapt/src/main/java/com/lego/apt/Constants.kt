...
import com.lego.apt.utility.noSpaces
...
object Constants {
    ...
    object Apis {
        ...
        const val PARAMETER_NAME_PREFIX = "lego"
    ...
    object KDoc {
        ...
        fun value(uri: String, version: String) =
            """
            |generated Lego Context Value class.
            |
            |context uri: [$uri]
            |version: $version
            """.trimMargin()
