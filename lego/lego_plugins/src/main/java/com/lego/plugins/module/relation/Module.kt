...
import com.ktnail.x.*
import com.lego.plugins.basic.exception.module.LegoModuleMavenGroupNotSetException
...
import com.lego.plugins.module.token.GitToken
...
class PubModule(
    ...
    inner class Pub(
        ...
        override val groupId
            get() = project.propertyOr(Ext.MODULES_SNAPSHOT_MAVEN_DEFAULT_GROUP_ID) { throw LegoModuleMavenGroupNotSetException() }
