package com.lego.plugins.module

import com.android.build.gradle.api.BaseVariant
import com.ktnail.x.Logger
import com.lego.plugins.basic.LogTags
import com.lego.plugins.basic.utility.*
import com.lego.plugins.module.config.ConfigPool
import com.lego.plugins.module.relation.*
import com.lego.plugins.module.task.ModulePublishTaskGraphic
import com.lego.plugins.module.task.publishAllTaskName
import com.lego.plugins.module.task.publishChangedTaskName
import com.lego.plugins.module.task.publishSourceTaskName
...
class ModuleController(
    ...
    companion object {
        ...
        const val LEGO_API_CONFIGURATION_NAME = "legoApi"
        const val LEGO_IMPLEMENTATION_CONFIGURATION_NAME = "legoImplementation"
    }
...
//            if (project != project.legoConfig) {
//                project.createDependencyType(LEGO_API_CONFIGURATION_NAME, DependencyType.API)
//                project.createDependencyType(LEGO_IMPLEMENTATION_CONFIGURATION_NAME, DependencyType.IMPLEMENTATION)
//            }
    ...
    private val String.gradleDependencyType
        get() = when (this) {
            LEGO_API_CONFIGURATION_NAME -> DependencyType.API
            LEGO_IMPLEMENTATION_CONFIGURATION_NAME -> DependencyType.IMPLEMENTATION
