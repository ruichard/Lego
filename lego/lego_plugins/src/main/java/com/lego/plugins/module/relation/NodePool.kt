...
import com.lego.plugins.basic.exception.module.LegoModuleProjectNodeNotFoundException
import com.lego.plugins.basic.utility.forEachVariant
import com.lego.plugins.basic.utility.isContextLibBuildType
import com.lego.plugins.basic.utility.match
import com.lego.plugins.basic.utility.whenExecuted
...
class NodePool(rootProject: Project, private val configs: ConfigPool) {
    ...
    private fun createModuleInPool(
        ...
        (nodes[project.path] ?: throw LegoModuleProjectNodeNotFoundException(project.path)).modules.getOrPut(variant.name) {
