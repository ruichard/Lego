...
import com.lego.plugins.basic.exception.LegoMultipleComponentDefinedException
...
/**
 *  Lego config extension of gradle plugins.
 *
 *  @since 1.3
 */
open class LegoConfigExtension(val project: Project) {
    // global
    ...
    fun register(context: ContextExtension) = context.apply {
        ...
        if (!contexts.containsKey(uri)) {
            ...
            throw LegoMultipleComponentDefinedException(uri)
        }
