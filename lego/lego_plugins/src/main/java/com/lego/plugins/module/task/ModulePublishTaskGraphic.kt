package com.lego.plugins.module.task
...
import com.lego.plugins.module.relation.PubModule
import com.lego.plugins.module.relation.localMode
...
class ModulePublishTaskGraphic(
    ...
    private fun getRootTask(project: Project, name: String): Task =
        project.getTasksByName(name, false).min() ?: project.legoModuleTask(name)
